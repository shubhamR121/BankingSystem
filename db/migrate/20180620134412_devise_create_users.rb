...
class DeviseCreateUsers < ActiveRecord::Migration[5.2]
  def change
    create_table :users do |t|
      ...
      t.string :fathers_occupation, null: false, default: ""
      t.string :mothers_occupation, null: false, default: ""
      t.string :phone_number, null: false, default: ""
      t.string :email, null: false, default: ""
      t.string :social_sucurity_number, null: false, default: ""
      t.string :pan, null: false, default: ""
      t.string :document, null: false, default: ""
      t.string :profile_photo, null: false, default: ""
